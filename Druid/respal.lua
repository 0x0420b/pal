  ...
  local settings = {
    ...
    template = {
      ...
      { type = "header", text = "Class Settings", align = "center" },
      {
        ...
        type = "spinner",
        text = "Iron Bark",
        desc = "Health Percent to Cast At",
        default = 66,
        min = 1,
        max = 100,
        step = 5
      ...
      {
        key = "wildgrowthnumber",
        type = "spinner",
        text = "Wild Growth Targets",
        desc = "Minimum Wild Growth Targets",
        default = 3,
        min = 1,
        max = 40,
        step = 1
      ...
      { type = "header", text = "Rejuvenation", align = "center" },
      {
        ...
        type = "spinner",
        text = "Max Rejuvenation Targets",
        desc = "Maximum Rejuvenation Targets",
        default = 10,
        min = 1,
        max = 20,
        step = 1
